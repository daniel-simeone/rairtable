...
#'
#' A vector of Airtable field types as of 2025-06-23. Find more information on
...
field_types <- tibble::tribble(
  ...
  "aiText",                "AI Text",                "https://airtable.com/developers/web/api/field-model#ai-text",                   "character", "TRUE",    "TRUE",
